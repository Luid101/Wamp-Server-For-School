<html>
	<header>
		...
		<h2>
			<u>Add a new Announcement bellow:</u>
		</h2>
			...
			if($submit)
			{
				...
				{ 
					...
					{						
						...
						if(checkdate(substr($start_date,8,2), substr($start_date,5,2), substr($start_date,0,4)) || checkdate(substr($end_date,8,2), substr($end_date,5,2), substr($end_date,0,4)) )
						{	
							if($monday)
							{
								$days[0] = 1;
